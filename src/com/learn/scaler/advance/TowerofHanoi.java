...
public class TowerofHanoi {
	...
	public static ArrayList<ArrayList<Integer>> towerOfHanoi(int A) {
		return toh(A, 1, 2, 3, new ArrayList<ArrayList<Integer>>());
	}

	public static ArrayList<ArrayList<Integer>> toh(int n, int src, int helper, int dest,
		...
		rows.add(dest);
		result.add(rows);
		toh(n - 1, helper, src, dest, result);
		return result;
	}
}
