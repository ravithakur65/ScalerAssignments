...
public class GenerateSubsets {
	public static void main(String[] args) {
		ArrayList<ArrayList<Integer>> subsets = subsets(Arrays.asList(1, 2, 3));
	...
	private static void generateSubsets(List<Integer> input, int index, ArrayList<ArrayList<Integer>> result,
